...
public class GetSelectedItem implements Initializable {
    @FXML
    ...
    //카테고리 목록을 저장할  Set collection 생성
    private Set<String> categorysSet = new HashSet<String>();
    //상품이름과 이미지 정보를 저장하고 있는 Map 컬렉션
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<String> dataList = FXCollections.observableArrayList(categorysSet);
    ...
    public void selectLeft(ActionEvent actionEvent) {
        ...
        //여러 개의 리스트들에서 category가 selectedCategory 와 동일한 품목만 추출합니다.
        ...
        //우측 콤보 박스 rightCombox에 항목들을 추가합니다.
        ...
        //우측 콤보 박스에서 사용 항 이벤트입니다.
        rightCombo.setOnAction(event -> {
            String selectedItem = (String) rightCombo.getSelectionModel().getSelectedItem();  //강등 필요
    ...
    private void fillDataFromFile() {
        ...
        try {
            ...
            while ((oneline = br.readLine()) != null) {
                ...
                categorysSet.add(myItem[0]);
            }
            System.out.println("카테고리 목록 :");
            System.out.println(categorysSet);
